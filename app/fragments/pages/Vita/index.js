...
export default class Vita extends React.Component {
  ...
  render(){
    ...
    const portraitImage = {
      backgroundImage: "url('static/vita/portrait-2019.jpg')"
    }
    ...
    return(
      <div id="__Vita">
        ...
        <section className="limiter">
          ...
          <aside className="imageContainer" aria-label="Portrait photo of Wenzel Massag. Year: 2019." style={portraitImage}>
